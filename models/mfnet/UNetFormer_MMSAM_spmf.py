...
SPMF_VARIANTS: dict[str, SPMFVariantSpec] = {
    ...
    "11": SPMFVariantSpec(
        ...
        fusion_cls=MultiScaleStructurePriorModulatedFusion11,
        indexes_attr="spmf11_indexes",
        structure_attr="structure_branch11",
        fusion_attr="spmf11",
        intermediate_modules=(
            ("spmf11", "spmf11", "spmf11"),
    ...
    "20": SPMFVariantSpec(
        variant_name="20",
        structure_branch_cls=DSMStructureBranch10,
        fusion_cls=MultiScaleStructurePriorModulatedFusion20,
        indexes_attr="spmf20_indexes",
        structure_attr="structure_branch10",
        fusion_attr="spmf20",
        intermediate_modules=(
            ("spmf20", "spmf20", "spmf20"),
    ...
    "21": SPMFVariantSpec(
        ...
        fusion_cls=MultiScaleStructurePriorModulatedFusion21,
