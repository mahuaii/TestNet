...
class UNetFormerPreAlignAuxAlign(UNetFormerPreAlign):
    def __init__(
        self,
        *args: object,
    ...
    def forward(
        ...
        if not return_align:
            return super().forward(x, y, mode=mode)
        ...
        deepx, deepy, x_align_feat, y_align_feat = self._encode_with_align(x, y_aligned)
