...
class UNetFormerDGSF10(UNetFormer):
    def __init__(
        self,
        *args: object,
    ...
    def _resolve_dgsf10_indexes(self) -> list[int]:
        ...
        if len(global_indexes) != 4:
            raise ValueError(
                "Expected exactly 4 encoder feature taps from global attention blocks, "
    ...
    def _encode_dgsf10_features(
        ...
        return (*rgb_encoder_features, rgb_top), (*aux_encoder_features, aux_top)
